...
**Early Display of Cancellation Policies:**
- **Building / Hotel Page** — expandable unit cards now show both Flexible (Moderate) and Lite (Non-refundable) options with prices and accurate policy notes.
- **Property / Unit Page** — policy options appear in the Rates section; selecting a policy updates the price context with smooth expand/collapse animations to show the full price breakdown.

#### <u>What's Coming Next</u>

- **Deliveries Management** *(SIBO)* — new foundation for managing add-on delivery services (pricing, availability, and cancellation rules) so agents can create and manage guest deliveries without manual city-by-city checks.
